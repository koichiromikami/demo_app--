...
class Customers(models.Model):
    ...
    sex = models.IntegerField(choices=gender_options, default=0)
    education = models.IntegerField(choices=education_options, default=0)
    marriage = models.IntegerField(choices=marital_options, default=0)
